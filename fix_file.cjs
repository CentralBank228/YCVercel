...
const startIdx = content.indexOf("{orderStatus !== 'idle' && (");
const endIdx = content.indexOf("{/* Offers/Promotions Section */}");
...
fs.writeFileSync('src/components/Cart.tsx', updatedContent);
console.log('Fixed Cart.tsx successfully!');
